...
- `${CLAUDE_SKILL_DIR}/patterns.md` — full copywriting pattern library and power-word lists
- `${CLAUDE_SKILL_DIR}/examples.md` — annotated examples from the three reference profiles (Vepa D., Abayomi O., Harsumeet S.)
