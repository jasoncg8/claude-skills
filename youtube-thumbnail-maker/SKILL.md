...
- **Style reference** — if the user pastes an image path, use it. Otherwise ask once for a reference image (or accept "no reference" / "use your judgment" as consent to skip).
...
7. Reference image is user-supplied; ask once if not given.
