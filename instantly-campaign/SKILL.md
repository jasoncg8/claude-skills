...
1. `${CLAUDE_SKILL_DIR}/winning-template.md` — the original 5 Danish emails verbatim. This is your exemplar. Mimic its rhythm, sentence length, HTML formatting, and CTA shape.
2. `${CLAUDE_SKILL_DIR}/voice-guide.md` — voice/formatting rules with do/don't examples.
